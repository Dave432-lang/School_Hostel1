...
VALUES 
('Crystal Rose Hostel', 'Ayeduase', 'Premium private hostel with top-notch security.', 'premium', 'mixed', 4500.00, 4.8, '["Wi-Fi", "AC", "Shuttle", "Study Room", "Security"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Evandy Hostel', 'Bomso', 'Affordable traditional setting off-campus.', 'standard', 'mixed', 2800.00, 4.0, '["Study Room", "Water Supply", "Security"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('The Penthouse', 'Campus Gate', 'Luxurious student living with private balcony.', 'executive', 'mixed', 5500.00, 4.9, '["Smart Lock", "Infinity Pool", "Gym", "Private Kitchen"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Queen Elizabeth Hall', 'Main Campus', 'Female-only residence with strict discipline.', 'standard', 'female', 1800.00, 4.2, '["24/7 Security", "Reading Hall", "Cafeteria"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Unity Hall (Conti)', 'Main Campus', 'One of the most vibrant male halls on campus.', 'standard', 'male', 1500.00, 3.8, '["Table Tennis", "Basketball Court", "Barber Shop"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Gaza Strip Hostel', 'Kotei', 'Lively environment popular with final year students.', 'standard', 'mixed', 2200.00, 3.5, '["Lush Garden", "Shared Kitchen", "Storage"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Hollywood Hostel', 'Ayeduase Extension', 'Modern architecture with spacious study environments.', 'premium', 'female', 4800.00, 4.7, '["Backup Generator", "Solar Power", "Elevator"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Flints Hostel', 'New Site', 'Quiet and serene, ideal for engineering students.', 'standard', 'mixed', 3200.00, 4.1, '["Fiber Internet", "Indoor Games", "Laundry"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Frontline Hostel', 'Bomso Corner', 'Direct access to the main road and shuttle stops.', 'executive', 'male', 5200.00, 4.6, '["Private Lounge", "Mini Mart", "Pharmacy"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Silicon Valley Hall', 'Tech Junction', 'High-tech hostel with smart features and co-working spaces.', 'premium', 'mixed', 5000.00, 5.0, '["Co-working Space", "Podcasting Studio", "Gaming Room"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Ahenema Hostel', 'Kotei Road', 'Traditional hospitality with modern comfort.', 'standard', 'mixed', 2600.00, 3.9, '["Summer Hut", "BBQ Area", "Parking"]', '{"rooms": [], "washrooms": [], "kitchens": []}'),
('Excellence Towers', 'Ayeduase South', 'The tallest hostel in the region with sky views.', 'executive', 'female', 6000.00, 4.9, '["Rooftop Restaurant", "Spa", "Beauty Salon"]', '{"rooms": [], "washrooms": [], "kitchens": []}');
